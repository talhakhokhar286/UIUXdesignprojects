...
function openApp(appName) {
    switch (appName) {
        ...
        case 'app4':
            ...
            break;
        case 'app5':
            window.open('https://www.figma.com/proto/JuFZL4lqO4myEcAUjmYpuY/My-Projects?node-id=1811-42976&node-type=canvas&t=a4Zp9mqwi9qIQ0kN-1&scaling=contain&content-scaling=fixed&page-id=1811%3A42807&starting-point-node-id=1811%3A42976');
            break;
        case 'app6':
        ...
        case 'app7':
            ...
            break;
        case 'app8':
            window.open('https://www.figma.com/proto/JuFZL4lqO4myEcAUjmYpuY/My-Projects?node-id=1778-28251&node-type=canvas&t=K4KqqRvyDk7Lxfek-1&scaling=contain&content-scaling=fixed&page-id=1778%3A28117&starting-point-node-id=1778%3A28810');
            break;
        case 'app9':
